...
# —————————————————————————————
SOURCE_SS_ID      = "1u_NwMt3CVVgozm04JGmccyTsNZnZGiHjG5y0Ko3YdaY"
SOURCE_SHEET_NAME = "Tutors"

DEST_SS_ID        = "1HItT2-PtZWoldYKL210hCQOLg3rh6U1Qj6NWkBjDjzk"
...
def main():
    ...
    cols_to_take = [0, 1, 2, 35, 4, 29, 30]  # A, B, C, J, E, AD, AE
